      ...
      <div className="max-w-2xl rounded shadow bg-white dark:bg-gray-800 py-6 pl-6 pr-12">
        ...
        <div className="md:flex items-center justify-between pt-6">
          <div className="flex items-center">
            ...
            <div className="pl-4">
              <p className="w-fit font-semibold leading-none text-gray-800 dark:text-gray-100">
                KES 230,500
              </p>
          ...
          <div className="flex items-center md:pt-0 pt-4 md:pl-10">
            ...
            <div className="pl-4">
              <p className="w-fit text-lg font-semibold leading-none text-gray-800 dark:text-gray-100">
                84
              </p>
              <p className="w-8 text-xs leading-3 text-gray-500 pt-2 dark:text-gray-400">
                Borrowers
